...
// === FUNÇÃO DE COBRAR WHATSAPP (CLIENTE OU CLIENTE/DIA) ===
window.cobrarWhats = (telefone, dataCompleta = null) => {
  ...
  // Agrupa produtos e datas das compras
  ...
  const dataAgendada = formatarData(vendas[0].dataReceber);
